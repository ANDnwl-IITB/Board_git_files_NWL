  ...
  component ahblite_controller is
   ...
   component afb_apb_bridge is
	port (
		...
		PENABLE: out std_logic_vector(0 downto 0); -- enable..
		PSLVERR: in std_logic_vector(0 downto 0); -- error from slave.
...
architecture afb_ahb_bridge_daemon_arch of afb_ahb_bridge_daemon is -- 
  ...
  signal WPIPE_AFB_BUS_RESPONSE_521_inst_req_0 : boolean;
  signal WPIPE_AFB_BUS_RESPONSE_521_inst_ack_0 : boolean;
  signal WPIPE_AFB_BUS_RESPONSE_521_inst_req_1 : boolean;
  signal WPIPE_AFB_BUS_RESPONSE_521_inst_ack_1 : boolean;
...
begin --  
  ...
  begin -- 
    ...
    rr_42_symbol_link_to_dp: control_delay_element -- 
      ...
      port map(clk => clk, reset => reset, req => afb_ahb_bridge_daemon_CP_9_elements(10), ack => RPIPE_AFB_BUS_REQUEST_460_inst_req_0); -- 
    ...
    cr_47_symbol_link_to_dp: control_delay_element -- 
      ...
      port map(clk => clk, reset => reset, req => afb_ahb_bridge_daemon_CP_9_elements(11), ack => RPIPE_AFB_BUS_REQUEST_460_inst_req_1); -- 
    ...
    ra_43_symbol_link_from_dp: control_delay_element -- 
      ...
      port map(clk => clk, reset => reset, req => RPIPE_AFB_BUS_REQUEST_460_inst_ack_0, ack => afb_ahb_bridge_daemon_CP_9_elements(12)); -- 
    ...
    ca_48_symbol_link_from_dp: control_delay_element -- 
      ...
      port map(clk => clk, reset => reset, req => RPIPE_AFB_BUS_REQUEST_460_inst_ack_1, ack => afb_ahb_bridge_daemon_CP_9_elements(13)); -- 
    ...
    req_56_symbol_link_to_dp: control_delay_element -- 
      ...
      port map(clk => clk, reset => reset, req => afb_ahb_bridge_daemon_CP_9_elements(14), ack => WPIPE_AFB_TO_AHB_COMMAND_502_inst_req_0); -- 
    ...
    ack_57_symbol_link_from_dp: control_delay_element -- 
      ...
      port map(clk => clk, reset => reset, req => WPIPE_AFB_TO_AHB_COMMAND_502_inst_ack_0, ack => afb_ahb_bridge_daemon_CP_9_elements(15)); -- 
    req_61_symbol_link_to_dp: control_delay_element -- 
      generic map(name => " req_61_symbol_delay",delay_value => 0)
      port map(clk => clk, reset => reset, req => afb_ahb_bridge_daemon_CP_9_elements(15), ack => WPIPE_AFB_TO_AHB_COMMAND_502_inst_req_1); -- 
    ...
    ack_62_symbol_link_from_dp: control_delay_element -- 
      ...
      port map(clk => clk, reset => reset, req => WPIPE_AFB_TO_AHB_COMMAND_502_inst_ack_1, ack => afb_ahb_bridge_daemon_CP_9_elements(16)); -- 
    ...
    rr_70_symbol_link_to_dp: control_delay_element -- 
      ...
      port map(clk => clk, reset => reset, req => afb_ahb_bridge_daemon_CP_9_elements(17), ack => RPIPE_AHB_TO_AFB_RESPONSE_506_inst_req_0); -- 
    ...
    cr_75_symbol_link_to_dp: control_delay_element -- 
      ...
      port map(clk => clk, reset => reset, req => afb_ahb_bridge_daemon_CP_9_elements(18), ack => RPIPE_AHB_TO_AFB_RESPONSE_506_inst_req_1); -- 
    ...
    ra_71_symbol_link_from_dp: control_delay_element -- 
      ...
      port map(clk => clk, reset => reset, req => RPIPE_AHB_TO_AFB_RESPONSE_506_inst_ack_0, ack => afb_ahb_bridge_daemon_CP_9_elements(19)); -- 
    ...
    ca_76_symbol_link_from_dp: control_delay_element -- 
      ...
      port map(clk => clk, reset => reset, req => RPIPE_AHB_TO_AFB_RESPONSE_506_inst_ack_1, ack => afb_ahb_bridge_daemon_CP_9_elements(20)); -- 
    ...
    -- CP-element group 21:  members (3) 
      -- CP-element group 21: 	 branch_block_stmt_456/do_while_stmt_457/do_while_stmt_457_loop_body/WPIPE_AFB_BUS_RESPONSE_521_sample_start_
      -- CP-element group 21: 	 branch_block_stmt_456/do_while_stmt_457/do_while_stmt_457_loop_body/WPIPE_AFB_BUS_RESPONSE_521_Sample/$entry
      -- CP-element group 21: 	 branch_block_stmt_456/do_while_stmt_457/do_while_stmt_457_loop_body/WPIPE_AFB_BUS_RESPONSE_521_Sample/req
      -- 
    req_84_symbol_link_to_dp: control_delay_element -- 
      generic map(name => " req_84_symbol_delay",delay_value => 0)
      port map(clk => clk, reset => reset, req => afb_ahb_bridge_daemon_CP_9_elements(21), ack => WPIPE_AFB_BUS_RESPONSE_521_inst_req_0); -- 
    ...
    -- CP-element group 22:  members (6) 
      -- CP-element group 22: 	 branch_block_stmt_456/do_while_stmt_457/do_while_stmt_457_loop_body/WPIPE_AFB_BUS_RESPONSE_521_sample_completed_
      -- CP-element group 22: 	 branch_block_stmt_456/do_while_stmt_457/do_while_stmt_457_loop_body/WPIPE_AFB_BUS_RESPONSE_521_update_start_
      -- CP-element group 22: 	 branch_block_stmt_456/do_while_stmt_457/do_while_stmt_457_loop_body/WPIPE_AFB_BUS_RESPONSE_521_Sample/$exit
      -- CP-element group 22: 	 branch_block_stmt_456/do_while_stmt_457/do_while_stmt_457_loop_body/WPIPE_AFB_BUS_RESPONSE_521_Sample/ack
      -- CP-element group 22: 	 branch_block_stmt_456/do_while_stmt_457/do_while_stmt_457_loop_body/WPIPE_AFB_BUS_RESPONSE_521_Update/$entry
      -- CP-element group 22: 	 branch_block_stmt_456/do_while_stmt_457/do_while_stmt_457_loop_body/WPIPE_AFB_BUS_RESPONSE_521_Update/req
      -- 
    ack_85_symbol_link_from_dp: control_delay_element -- 
      generic map(name => " 22_delay",delay_value => 0)
      port map(clk => clk, reset => reset, req => WPIPE_AFB_BUS_RESPONSE_521_inst_ack_0, ack => afb_ahb_bridge_daemon_CP_9_elements(22)); -- 
    req_89_symbol_link_to_dp: control_delay_element -- 
      generic map(name => " req_89_symbol_delay",delay_value => 0)
      port map(clk => clk, reset => reset, req => afb_ahb_bridge_daemon_CP_9_elements(22), ack => WPIPE_AFB_BUS_RESPONSE_521_inst_req_1); -- 
    ...
    -- CP-element group 23:  members (3) 
      -- CP-element group 23: 	 branch_block_stmt_456/do_while_stmt_457/do_while_stmt_457_loop_body/WPIPE_AFB_BUS_RESPONSE_521_update_completed_
      -- CP-element group 23: 	 branch_block_stmt_456/do_while_stmt_457/do_while_stmt_457_loop_body/WPIPE_AFB_BUS_RESPONSE_521_Update/$exit
      -- CP-element group 23: 	 branch_block_stmt_456/do_while_stmt_457/do_while_stmt_457_loop_body/WPIPE_AFB_BUS_RESPONSE_521_Update/ack
      -- 
    ack_90_symbol_link_from_dp: control_delay_element -- 
      generic map(name => " 23_delay",delay_value => 0)
      port map(clk => clk, reset => reset, req => WPIPE_AFB_BUS_RESPONSE_521_inst_ack_1, ack => afb_ahb_bridge_daemon_CP_9_elements(23)); -- 
    ...
    condition_evaluated_33_symbol_link_to_dp: control_delay_element -- 
      ...
      port map(clk => clk, reset => reset, req => afb_ahb_bridge_daemon_CP_9_elements(24), ack => do_while_stmt_457_branch_req_0); -- 
    ...
    ack_95_symbol_link_from_dp: control_delay_element -- 
      ...
      port map(clk => clk, reset => reset, req => do_while_stmt_457_branch_ack_0, ack => afb_ahb_bridge_daemon_CP_9_elements(26)); -- 
    ...
    ack_99_symbol_link_from_dp: control_delay_element -- 
      ...
      port map(clk => clk, reset => reset, req => do_while_stmt_457_branch_ack_1, ack => afb_ahb_bridge_daemon_CP_9_elements(27)); -- 
    ...
    afb_ahb_bridge_daemon_do_while_stmt_457_terminator_100: loop_terminator -- 
      generic map (name => " afb_ahb_bridge_daemon_do_while_stmt_457_terminator_100", max_iterations_in_flight =>15) 
  ...
  data_path: Block -- 
    ...
    signal access_error_511 : std_logic_vector(0 downto 0);
  ...
  begin -- 
    ...
    -- flow-through slice operator slice_510_inst
    access_error_511 <= ahb_response_507(32 downto 32);
    -- flow-through slice operator slice_514_inst
    data_out_mem_515 <= ahb_response_507(31 downto 0);
    do_while_stmt_457_branch: Block -- 
      -- branch-block
      signal condition_sig : std_logic_vector(0 downto 0);
      begin 
      condition_sig <= konst_525_wire_constant;
    ...
    -- flow through binary operator CONCAT_u1_u33_519_inst
    process(access_error_511, data_out_mem_515) -- 
      variable tmp_var : std_logic_vector(32 downto 0); -- 
    begin -- 
      ApConcat_proc(access_error_511, data_out_mem_515, tmp_var);
      to_afb_520 <= tmp_var; --
    end process;
    ...
    -- shared outport operator group (0) : WPIPE_AFB_BUS_RESPONSE_521_inst 
    OutportGroup_0: Block -- 
      ...
      -- 
    begin -- 
      sample_req_unguarded(0) <= WPIPE_AFB_BUS_RESPONSE_521_inst_req_0;
      WPIPE_AFB_BUS_RESPONSE_521_inst_ack_0 <= sample_ack_unguarded(0);
      update_req_unguarded(0) <= WPIPE_AFB_BUS_RESPONSE_521_inst_req_1;
      WPIPE_AFB_BUS_RESPONSE_521_inst_ack_1 <= update_ack_unguarded(0);
      guard_vector(0)  <=  '1';
      data_in <= to_afb_520;
...
end entity afb_apb_bridge;


architecture Triv of afb_apb_bridge is
	...
	signal ajit_to_env_data: std_logic_vector(31 downto 0);
	signal ajit_to_env_read_write_bar: std_logic;
...
begin
	...
	ajit_to_env_write_req <= afb_request_pipe_write_req(0);
	afb_request_pipe_write_ack(0) <= ajit_to_env_write_ack;
	ajit_to_env_data   <= afb_request_pipe_write_data(31 downto 0);
	ajit_to_env_addr   <= afb_request_pipe_write_data(63 downto 32);
	ajit_to_env_read_write_bar <= afb_request_pipe_write_data (72);

	c0(0) <= env_to_ajit_error;
	afb_response_pipe_read_data <= (c0 & env_to_ajit_read_data);
	env_to_ajit_read_req <= afb_response_pipe_read_req(0);
	afb_response_pipe_read_ack(0) <= env_to_ajit_read_ack;

	base_inst: ajit_apb_master
		port map 
		  (
			ajit_to_env_write_req,
			ajit_to_env_write_ack,
			ajit_to_env_addr,
			ajit_to_env_data,
			ajit_to_env_read_write_bar,
			env_to_ajit_error ,
			env_to_ajit_read_data ,
			env_to_ajit_read_req,
			env_to_ajit_read_ack,
			PRESETn(0),
			PCLK(0),
			PADDR,
			PWRITE(0),
...
--
architecture Mixed of apb_sram is
