...
architecture VhpiLink of nic_Test_Bench is -- 
  ...
  signal free_queue_daemon_tag_in: std_logic_vector(1 downto 0);
  signal free_queue_daemon_tag_out: std_logic_vector(1 downto 0);
  signal free_queue_daemon_start_req : std_logic := '0';
  signal free_queue_daemon_start_ack : std_logic := '0';
  signal free_queue_daemon_fin_req   : std_logic := '0';
  signal free_queue_daemon_fin_ack   : std_logic := '0';
  signal macTestDaemon_tag_in: std_logic_vector(1 downto 0);
  signal macTestDaemon_tag_out: std_logic_vector(1 downto 0);
  signal macTestDaemon_start_req : std_logic := '0';
  signal macTestDaemon_start_ack : std_logic := '0';
  signal macTestDaemon_fin_req   : std_logic := '0';
  signal macTestDaemon_fin_ack   : std_logic := '0';
  ...
  signal receive_queue_daemon_tag_in: std_logic_vector(1 downto 0);
  signal receive_queue_daemon_tag_out: std_logic_vector(1 downto 0);
  signal receive_queue_daemon_start_req : std_logic := '0';
  signal receive_queue_daemon_start_ack : std_logic := '0';
  signal receive_queue_daemon_fin_req   : std_logic := '0';
  signal receive_queue_daemon_fin_ack   : std_logic := '0';
  signal transmit_queue_daemon_tag_in: std_logic_vector(1 downto 0);
  signal transmit_queue_daemon_tag_out: std_logic_vector(1 downto 0);
  signal transmit_queue_daemon_start_req : std_logic := '0';
  signal transmit_queue_daemon_start_ack : std_logic := '0';
  signal transmit_queue_daemon_fin_req   : std_logic := '0';
  signal transmit_queue_daemon_fin_ack   : std_logic := '0';
...
begin --
  ...
  nic_instance: nic -- 
    port map ( -- 
      ...
      MAC_ENABLE_pipe_read_data  => MAC_ENABLE_pipe_read_data, 
      MAC_ENABLE_pipe_read_req  => MAC_ENABLE_pipe_read_req, 
      MAC_ENABLE_pipe_read_ack  => MAC_ENABLE_pipe_read_ack ,
