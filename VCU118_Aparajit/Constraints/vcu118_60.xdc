...
# 250 MHz DDR4 system clock (differential) -- VCU118 bank location
...
##################################################################################################
## CDC: three fully asynchronous clock domains
##################################################################################################
...
set CLK_60_NAME  [get_clocks clk_out1_clk_wiz_1]
set MIG_CLK_NAME [get_clocks mmcm_clkout0]
set ETH_125_NAME [get_clocks clk_125mhz_mmcm_out]

set_clock_groups -asynchronous -group $CLK_60_NAME  -group $ETH_125_NAME
set_clock_groups -asynchronous -group $CLK_60_NAME  -group $MIG_CLK_NAME
set_clock_groups -asynchronous -group $ETH_125_NAME -group $MIG_CLK_NAME
