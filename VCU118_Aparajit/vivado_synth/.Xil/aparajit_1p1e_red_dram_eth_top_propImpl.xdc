set_property SRC_FILE_INFO {cfile:/home/madhav/AjitHpcBoards_local/AjitHpcBoards/aparajit_1p1e_red_ethernet/Constraints/vcu118_60.xdc rfile:../../Constraints/vcu118_60.xdc id:1} [current_design]
...
set_clock_groups -asynchronous -group [get_clocks clk_out1_clk_wiz_1]  -group [get_clocks clk_125mhz_mmcm_out]
set_property src_info {type:XDC file:1 line:255 export:INPUT save:INPUT read:READ} [current_design]
set_clock_groups -asynchronous -group [get_clocks clk_out1_clk_wiz_1]  -group [get_clocks mmcm_clkout0]
set_property src_info {type:XDC file:1 line:256 export:INPUT save:INPUT read:READ} [current_design]
set_clock_groups -asynchronous -group [get_clocks clk_125mhz_mmcm_out] -group [get_clocks mmcm_clkout0]
