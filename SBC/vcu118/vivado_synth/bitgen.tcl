...
# ==============================================================================
read_vhdl ../toplevel/vcu118_fpga_top_ethernet.vhdl
...
# CONSTRAINT FILE
# ==============================================================================
read_xdc ../constraint/vcu118_ethernet.xdc
...
synth_design -top vcu118_fpga_top -part xcvu9p-flga2104-2L-e
...
processor_1x1x32.fpgaTop.vcu118.ethernet.bit

write_debug_probes -force \
processor_1x1x32.fpgaTop.vcu118.ethernet.ltx
