...
uint8_t* lockStartAddr   = 0x4001c000;
uint8_t* lockStartAddrNc = 0x4001d000; // non-cacheable
...
void cortos_init_locks() {
  ...
  uint8_t* lockStartAddr   = (uint8_t*)0x4001c000;
  uint8_t* lockStartAddrNc = (uint8_t*)0x4001d000; // non-cacheable
