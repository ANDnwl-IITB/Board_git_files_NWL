...
#
buildHierarchicalModel.py -M -u -H -s ghdl  -a  kcu105_core_kcu105_core_lib -J DualClockedFifos/DualClockedFifos.hsys -J ./GlueModules/GlueModules.hsys -I $AHIR_RELEASE/include $PARAMETERS $PIPES $SIGNALS
