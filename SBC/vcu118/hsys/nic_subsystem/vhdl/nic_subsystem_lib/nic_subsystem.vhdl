...
begin -- 
  ...
  port map ( --
    ...
    MAC_ENABLE_pipe_read_data => nic_mac_enable_pipe_write_data,
    MAC_ENABLE_pipe_read_req => nic_mac_enable_pipe_write_ack,
    MAC_ENABLE_pipe_read_ack => nic_mac_enable_pipe_write_req,
