...
architecture struct of kcu105_core is -- 
  ...
  -->>>>>
  for DualClockedQueue_ACB_Dram_Bridge_req_inst :  DualClockedQueue_ACB_req_wrap -- 
  ...
  --<<<<<
  -->>>>>
  for DualClockedQueue_Dram_Bridge_ACB_resp_inst :  DualClockedQueue_ACB_resp_wrap -- 
    use entity DualClockedQueue_lib.DualClockedQueue_ACB_resp_wrap; -- 
  --<<<<<
...
begin -- 
  hsys_tie_low  <= '0';
  hsys_tie_high <= '1';
  DualClockedQueue_ACB_Dram_Bridge_req_inst: DualClockedQueue_ACB_req_wrap
  port map ( --
    fifo_reset => RESET_TO_NIC,
    read_clk => CLOCK_TO_DRAMCTRL_BRIDGE,
    read_data_pipe_read_data => ACB_DRAM_REQUEST_FIFO_OUT_pipe_write_data,
    read_data_pipe_read_req => ACB_DRAM_REQUEST_FIFO_OUT_pipe_write_ack,
    read_data_pipe_read_ack => ACB_DRAM_REQUEST_FIFO_OUT_pipe_write_req,
    write_clk => CLOCK_TO_NIC,
    write_data_pipe_write_data => ACB_DRAM_REQUEST_FIFO_IN_pipe_read_data,
    write_data_pipe_write_req => ACB_DRAM_REQUEST_FIFO_IN_pipe_read_ack,--edited
    write_data_pipe_write_ack => ACB_DRAM_REQUEST_FIFO_IN_pipe_read_req,
  ...
  port map ( --
    ...
    read_data_pipe_read_data => PROCESSOR_ACB_REQUEST_FIFO_OUT_pipe_write_data,
    read_data_pipe_read_req => PROCESSOR_ACB_REQUEST_FIFO_OUT_pipe_write_ack,
    read_data_pipe_read_ack => PROCESSOR_ACB_REQUEST_FIFO_OUT_pipe_write_req,
    write_clk => CLOCK_80,
    write_data_pipe_write_data => PROCESSOR_ACB_REQUEST_FIFO_IN_pipe_read_data,
    write_data_pipe_write_req => PROCESSOR_ACB_REQUEST_FIFO_IN_pipe_read_ack,--edited
    write_data_pipe_write_ack => PROCESSOR_ACB_REQUEST_FIFO_IN_pipe_read_req,
    clk => hsys_tie_low,  reset => hsys_tie_low
    ); -- 
  ...
  port map ( --
    fifo_reset => RESET_TO_NIC,
    read_clk => CLOCK_80,
    read_data_pipe_read_data => PROCESSOR_ACB_RESPONSE_FIFO_OUT_pipe_write_data,
    read_data_pipe_read_req => PROCESSOR_ACB_RESPONSE_FIFO_OUT_pipe_write_ack,
    read_data_pipe_read_ack => PROCESSOR_ACB_RESPONSE_FIFO_OUT_pipe_write_req,
    write_clk => CLOCK_TO_NIC,
    write_data_pipe_write_data => PROCESSOR_ACB_RESPONSE_FIFO_IN_pipe_read_data,
    write_data_pipe_write_req => PROCESSOR_ACB_RESPONSE_FIFO_IN_pipe_read_ack,--edited
    write_data_pipe_write_ack => PROCESSOR_ACB_RESPONSE_FIFO_IN_pipe_read_req,
    clk => hsys_tie_low,  reset => hsys_tie_low
    ); -- 
  DualClockedQueue_Dram_Bridge_ACB_resp_inst: DualClockedQueue_ACB_resp_wrap
  port map ( --
    fifo_reset => RESET_TO_DRAMCTRL_BRIDGE,
    read_clk => CLOCK_TO_NIC,
    read_data_pipe_read_data => DRAM_ACB_RESPONSE_FIFO_OUT_pipe_write_data,
    read_data_pipe_read_req => DRAM_ACB_RESPONSE_FIFO_OUT_pipe_write_ack,
    read_data_pipe_read_ack => DRAM_ACB_RESPONSE_FIFO_OUT_pipe_write_req,
    write_clk => CLOCK_TO_DRAMCTRL_BRIDGE,
    write_data_pipe_write_data => DRAM_ACB_RESPONSE_FIFO_IN_pipe_read_data,
    write_data_pipe_write_req => DRAM_ACB_RESPONSE_FIFO_IN_pipe_read_ack,--edited
    write_data_pipe_write_ack => DRAM_ACB_RESPONSE_FIFO_IN_pipe_read_req,
    clk => hsys_tie_low,  reset => hsys_tie_low
    ); -- 
