...
(
    ...
    // ADDED: Pass the physical reset pin out to the top level
    output wire       phy_reset_n, 
    
    // REMOVED: phy_mdio and phy_mdc are completely gone
...
fpga_top_kcu105 fpga_top_kcu105_inst
(
     .clk_100mhz_ibufg(clk_100mhz_ibufg),
     .reset(reset),
