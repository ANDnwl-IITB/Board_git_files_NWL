...
compileToSparcUclibc.py \
  ...
  -D AJIT \
  -U \
  -D USE_VMAP -D USE_CORTOS -D CLK_FREQUENCY=80000000 -c $AJIT_HOME/AI_NIC_DEMO/SBC/vcu128_updated/testing/testingNIC_1.2/main.c -I $AJIT_HOME/AI_NIC_DEMO/Networking/NIC_1.2/driver/include -C $AJIT_HOME/AI_NIC_DEMO/Networking/NIC_1.2/driver/src;
