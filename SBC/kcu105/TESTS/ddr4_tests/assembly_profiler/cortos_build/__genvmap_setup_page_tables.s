...
page_table_setup:
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=29, level=3,  ppnr=0x4001d000, p_addr=0x74, cacheable=0x0, acc=0x3
   ! *(PAGE_TABLE_BASE + 0x74) = 0x4001d0e (pte)
   set 0x4001d0e, %g2
   set 0x74, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=21, level=3,  ppnr=0xc0015000, p_addr=0x254, cacheable=0x1, acc=0x3
   ! *(PAGE_TABLE_BASE + 0x254) = 0xc00158e (pte)
   set 0xc00158e, %g2
   set 0x254, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=30, level=3,  ppnr=0xc001e000, p_addr=0x278, cacheable=0x1, acc=0x4
   ! *(PAGE_TABLE_BASE + 0x278) = 0xc001e92 (pte)
   set 0xc001e92, %g2
   set 0x278, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=38, level=3,  ppnr=0xc0026000, p_addr=0x298, cacheable=0x1, acc=0x3
   ! *(PAGE_TABLE_BASE + 0x298) = 0xc00268e (pte)
   set 0xc00268e, %g2
   set 0x298, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=39, level=3,  ppnr=0xc0027000, p_addr=0x29c, cacheable=0x1, acc=0x3
   ! *(PAGE_TABLE_BASE + 0x29c) = 0xc00278e (pte)
   set 0xc00278e, %g2
   set 0x29c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=40, level=3,  ppnr=0xc0028000, p_addr=0x2a0, cacheable=0x1, acc=0x3
   ! *(PAGE_TABLE_BASE + 0x2a0) = 0xc00288e (pte)
   set 0xc00288e, %g2
   set 0x2a0, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=41, level=3,  ppnr=0xc0029000, p_addr=0x2a4, cacheable=0x1, acc=0x3
   ! *(PAGE_TABLE_BASE + 0x2a4) = 0xc00298e (pte)
   set 0xc00298e, %g2
   set 0x2a4, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=42, level=3,  ppnr=0xc002a000, p_addr=0x2a8, cacheable=0x1, acc=0x3
   ! *(PAGE_TABLE_BASE + 0x2a8) = 0xc002a8e (pte)
   set 0xc002a8e, %g2
   set 0x2a8, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=43, level=3,  ppnr=0xc002b000, p_addr=0x2ac, cacheable=0x1, acc=0x3
   ! *(PAGE_TABLE_BASE + 0x2ac) = 0xc002b8e (pte)
   set 0xc002b8e, %g2
   set 0x2ac, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=44, level=3,  ppnr=0xc002c000, p_addr=0x2b0, cacheable=0x1, acc=0x3
   ! *(PAGE_TABLE_BASE + 0x2b0) = 0xc002c8e (pte)
   set 0xc002c8e, %g2
   set 0x2b0, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=45, level=3,  ppnr=0xc002d000, p_addr=0x2b4, cacheable=0x1, acc=0x3
   ! *(PAGE_TABLE_BASE + 0x2b4) = 0xc002d8e (pte)
   set 0xc002d8e, %g2
   set 0x2b4, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=46, level=3,  ppnr=0xc002e000, p_addr=0x2b8, cacheable=0x1, acc=0x3
   ! *(PAGE_TABLE_BASE + 0x2b8) = 0xc002e8e (pte)
   set 0xc002e8e, %g2
   set 0x2b8, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=47, level=3,  ppnr=0xc002f000, p_addr=0x2bc, cacheable=0x1, acc=0x4
   ! *(PAGE_TABLE_BASE + 0x2bc) = 0xc002f92 (pte)
   set 0xc002f92, %g2
   set 0x2bc, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
