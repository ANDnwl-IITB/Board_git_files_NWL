...
#
buildHierarchicalModel.py -M -u -H -s ghdl  -a  sbc_kcu105_core_sbc_kcu105_core_lib -J DualClockedFifos/DualClockedFifos.hsys -I $AHIR_RELEASE/include $PARAMETERS $PIPES $SIGNALS
