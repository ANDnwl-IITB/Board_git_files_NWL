...
page_table_setup:
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=32, level=3,  ppnr=0x40020000, p_addr=0x80, cacheable=0x1, acc=0x2
   ! *(PAGE_TABLE_BASE + 0x80) = 0x400208a (pte)
   set 0x400208a, %g2
   set 0x80, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=33, level=3,  ppnr=0x40021000, p_addr=0x84, cacheable=0x1, acc=0x2
   ! *(PAGE_TABLE_BASE + 0x84) = 0x400218a (pte)
   set 0x400218a, %g2
   set 0x84, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=34, level=3,  ppnr=0x40022000, p_addr=0x88, cacheable=0x1, acc=0x2
   ! *(PAGE_TABLE_BASE + 0x88) = 0x400228a (pte)
   set 0x400228a, %g2
   set 0x88, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=35, level=3,  ppnr=0x40023000, p_addr=0x8c, cacheable=0x1, acc=0x2
   ! *(PAGE_TABLE_BASE + 0x8c) = 0x400238a (pte)
   set 0x400238a, %g2
   set 0x8c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=36, level=3,  ppnr=0x40024000, p_addr=0x90, cacheable=0x1, acc=0x2
   ! *(PAGE_TABLE_BASE + 0x90) = 0x400248a (pte)
   set 0x400248a, %g2
   set 0x90, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=3, level=3,  ppnr=0x40043000, p_addr=0x10c, cacheable=0x0, acc=0x3
   ! *(PAGE_TABLE_BASE + 0x10c) = 0x400430e (pte)
   set 0x400430e, %g2
   set 0x10c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=5, level=3,  ppnr=0x40045000, p_addr=0x114, cacheable=0x1, acc=0x4
   ! *(PAGE_TABLE_BASE + 0x114) = 0x4004592 (pte)
   set 0x4004592, %g2
   set 0x114, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=8, level=3,  ppnr=0x40048000, p_addr=0x120, cacheable=0x1, acc=0x4
   ! *(PAGE_TABLE_BASE + 0x120) = 0x4004892 (pte)
   set 0x4004892, %g2
   set 0x120, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
