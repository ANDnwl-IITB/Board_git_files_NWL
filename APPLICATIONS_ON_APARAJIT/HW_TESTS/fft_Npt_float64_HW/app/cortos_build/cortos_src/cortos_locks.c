...
uint8_t* lockStartAddr   = 0x40042000;
uint8_t* lockStartAddrNc = 0x40043000; // non-cacheable
...
void cortos_init_locks() {
  ...
  uint8_t* lockStartAddr   = (uint8_t*)0x40042000;
  uint8_t* lockStartAddrNc = (uint8_t*)0x40043000; // non-cacheable
