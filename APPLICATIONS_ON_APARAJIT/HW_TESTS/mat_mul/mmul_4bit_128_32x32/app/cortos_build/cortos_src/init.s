...
SETUP_THREAD_0_0:
  ...
  set 0x40025fa0, %sp  ! set stack address
  clr %fp
...
__cortos_init_region_to_zero:
  ...
  sethi %hi(0x4001a000), %l0
  or %l0, %lo(0x4001a000), %l0

  ! set the first illegal address
  sethi %hi(0x40020000), %l2
  or %l2, %lo(0x40020000), %l2
...
_cortos_zero_init_area_BssSection:
  ...
  ! set the base address
  sethi %hi(0x40020000), %l0
  or %l0, %lo(0x40020000), %l0

  ! set the first illegal address
  sethi %hi(0x40021000), %l2
  or %l2, %lo(0x40021000), %l2
  sub %l2, 0x4, %l2         ! address of last valid word location
...
_cortos_zero_init_area_CacheableLocks:
  ...
  ! set the base address
  sethi %hi(0x40021000), %l0
  or %l0, %lo(0x40021000), %l0

  ! set the first illegal address
  sethi %hi(0x40022000), %l2
  or %l2, %lo(0x40022000), %l2
  sub %l2, 0x4, %l2         ! address of last valid word location
