...
page_table_setup:
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=33, level=3,  ppnr=0x40021000, p_addr=0x84, cacheable=0x0, acc=0x3
   ! *(PAGE_TABLE_BASE + 0x84) = 0x400210e (pte)
   set 0x400210e, %g2
   set 0x84, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=35, level=3,  ppnr=0x40023000, p_addr=0x8c, cacheable=0x1, acc=0x4
   ! *(PAGE_TABLE_BASE + 0x8c) = 0x4002392 (pte)
   set 0x4002392, %g2
   set 0x8c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=38, level=3,  ppnr=0x40026000, p_addr=0x98, cacheable=0x1, acc=0x4
   ! *(PAGE_TABLE_BASE + 0x98) = 0x4002692 (pte)
   set 0x4002692, %g2
   set 0x98, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
