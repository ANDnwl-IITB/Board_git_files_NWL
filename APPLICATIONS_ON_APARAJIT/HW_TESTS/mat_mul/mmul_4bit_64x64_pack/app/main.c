...

{
	...
	while(writeThreadDataRegister (&hms, 0, 0, TID, 7, ENGINE_DMEM_BASE_POINTER  ));
	while(writeThreadDataRegister (&hms, 0, 0, TID, 7, ENGINE_DMEM_BASE_POINTER + 32768));
