...
def main():
    ...
    # Write Output Files (Standard word indices)
    ...
    with open("result.txt", "w") as f:
        for word_idx in sorted(results_map.keys()):
            f.write(f"0 mem 0x{word_idx:X} 0x{results_map[word_idx]:016X}\n")

    print(f"Success! Standard unpacked (32x64 * 64x32) files generated.")
