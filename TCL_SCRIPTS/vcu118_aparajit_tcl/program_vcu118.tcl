...
# Probe file
set_property PROBES.FILE {../../VCU118_Aparajit_bitfiles/bitfile_24aug/engine_ethernet.fpgaTop.vcu118.ltx} \
    [get_hw_devices xcvu9p_0]

set_property FULL_PROBES.FILE {../../VCU118_Aparajit_bitfiles/bitfile_24aug/engine_ethernet.fpgaTop.vcu118.ltx} \
    [get_hw_devices xcvu9p_0]

# Bitstream
set_property PROGRAM.FILE {../../VCU118_Aparajit_bitfiles/bitfile_24aug/engine_ethernet.fpgaTop.vcu118.bit} \
    [get_hw_devices xcvu9p_0]
