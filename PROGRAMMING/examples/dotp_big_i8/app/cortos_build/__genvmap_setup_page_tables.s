...
page_table_setup:
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=37, level=3,  ppnr=0x40025000, p_addr=0x94, cacheable=0x0, acc=0x3
   ! *(PAGE_TABLE_BASE + 0x94) = 0x400250e (pte)
   set 0x400250e, %g2
   set 0x94, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=39, level=3,  ppnr=0x40027000, p_addr=0x9c, cacheable=0x1, acc=0x4
   ! *(PAGE_TABLE_BASE + 0x9c) = 0x4002792 (pte)
   set 0x4002792, %g2
   set 0x9c, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
   ...
   add %g5, %g1, %g3
   st %g2, [%g3]
   !PTE: context=0, index=42, level=3,  ppnr=0x4002a000, p_addr=0xa8, cacheable=0x1, acc=0x4
   ! *(PAGE_TABLE_BASE + 0xa8) = 0x4002a92 (pte)
   set 0x4002a92, %g2
   set 0xa8, %g5
   add %g5, %g1, %g3
   st %g2, [%g3]
